...
class Lex(): 
    def __init__(self):
        ...
        self.sox_command = 'sox -d -t wavpcm -c 1 -b 16 -r 16000 -e signed-integer --endian little - silence 1 0 1% 5 0.275t 8% > ' + self.input_fname
    ...
    def play_response(self, response):
        ...
        os.system('mpg321 ' + self.response_fname)
